(function ($) {
  ...
  if ($(".menu-trigger").length) {
    $(".menu-trigger").on("click", function () {
      ...
      $(".mobile-navbar-custom").toggleClass("show");
      $(".mobile-navbar-custom").removeClass("next-profile");
      $("#activeNextProfile").removeClass("active");
    });

    $("#nextProfile").on("click", function () {
      $(".mobile-navbar-custom").toggleClass("next-profile");
      $("#activeNextProfile").toggleClass("active");
    });
  }
...
function toggleTopButton() {
  if (
    ...
    document.getElementById("back-to-up").classList.remove("hide");
  } else {
    document.getElementById("back-to-up").classList.add("hide");
  }
}
  ...
  var filterList = {
    init: function () {
      ...
      $("#portfoliolist").mixItUp({
        ...
        load: {
          filter: ".portfolios, .company-profile, .katalog",
        },
      });
    },
  };
